...
Z_REPORT_D753_F0_P19_U1_2024-07-26_16-00-15.tcurep.zip
...
|ReportNumber                    | + |Int32  |ID підсумкового Z звіту|
...
|AmountOfServicePayIn            | + |Double |Сума службових внесків|
|AmountOfServicePayOut           | + |Double |Сума службових виносів|
|ChequeFiles                     | + |String |Перелік імен файлів чеків та гвідів чеків через кому у наступному форматі: ім'я чека №1:{GUID чека №1}, ім'я чека №2:{GUID чека №2}, ..., ім'я чека №N:{GUID чека №N}|
...
1. Службове внесення 1093.20
2. Продажі на суму 24913.40
3. Службове внесення 26006.60
